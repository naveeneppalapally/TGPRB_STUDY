      ...
      traps: [
        {
          ...
          right: 'Member of a House',
          why: 'The President belongs to Parliament (Art. 79) without sitting in either House.',
          statements: [
            { text: 'President of India', side: 'left' },
            { text: 'Nominated Rajya Sabha member', side: 'right' },
            { text: 'Speaker of Lok Sabha', side: 'right' },
            { text: 'Vice-President as Chairman of Rajya Sabha', side: 'left' },
          ],
        },
      ],
    },
